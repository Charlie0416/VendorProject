...
import RepairButton from '../components/button/RepairButton'
...
export default React.memo(function RepairView() {
    const [,showClassName] = usePage( PAGES.REPAIR);
    ...
    return (
        <div className={showClassName}
            ...
            <div
                ...
                <RepairButton customerDispatch={customerDispatch} />
            </div>
            ...
            <div
                ...
                <RepairTable customers={searchCustomer} customerDispatch={customerDispatch} />
