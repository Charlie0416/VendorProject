...
export default React.memo(function CustomerView() {
    const [,showClassName] = usePage( PAGES.PURCHASE);
    ...
    return (
        <div className={showClassName}
            ...
            <div
                ...
                <PurchaseButton customerDispatch={customerDispatch} />
            </div>
            ...
            <div
                ...
                <PurchaseTable customers={searchCustomer} customerDispatch={customerDispatch} />
