...
import DoingTable from '../components/table/DoingTable';
import DoingButton from '../components/button/DoingButton';
export default React.memo(function DoingView() {
    const [,showClassName] = usePage( PAGES.DOING);
    ...
    return (
        <div className={showClassName}
            ...
            <div
                ...
                <DoingButton customerDispatch={customerDispatch} />
            </div>
            ...
            <div
                ...
                <DoingTable customers={searchCustomer} customerDispatch={customerDispatch} />
